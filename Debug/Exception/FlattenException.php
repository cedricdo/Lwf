...
class FlattenException
{
    ...
    public function __construct(\Throwable $exception, $statusCode = null, array $headers = array())
    {
        ...
        if ($exception->getPrevious()) {
            $this->setPrevious(new self($exception->getPrevious()));
        }
    ...
    public function setTraceFromException(\throwable $exception)
    {
