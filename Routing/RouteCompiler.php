...
use Lwf\Routing\Exception\DomainException;
use Lwf\Routing\Exception\LogicException;
...
class RouteCompiler implements RouteCompilerInterface
{
    ...
    /**
     * Compile a pattern of a Route
     *
     * @param Route  $route   The Route Object
     * @param string $pattern The pattern
     * @param bool   $isHost  True if the pattern is a host name
     *
     * @return array
     *
